...
export default {
  ...
  asyncData({ store }) {
    let themeConfig = {
      global: {
        themeColor: '#234904',
        backgroundColor: '#234904',
      },
      headerSection: {
        brandLogo: {
          description: 'naga-world.com ',
          url:
            'http://localhost:3000/_nuxt/assets/img/SECTION_HEADER_LOGO/LOGO-NGWORLD_BG.png',
        },
        moneyBagIcon: {
          description: '',
      ...
      footerSection: {
        ...
        copyrightBy: 'NAGA WORLD',
        SupportedBy: 'NagaWorld.com ',
      },
    }
...
.loader {
  ...
  background: url('https://i.pinimg.com/originals/91/ae/56/91ae5683045f6dbef16b1482bade938f.png')
    center center no-repeat #094d0e;
