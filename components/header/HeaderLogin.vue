...
<div class="header-login">
    ...
    <div class="row header-desktop">
        <div class="col-12 header text-center py-2">
            <nuxt-link :to="{patch : '/'}" class="text-left">
                ...
                <b-img class="header-img" :src="require(`@/assets/img/SECTION_HEADER_LOGO/LOGO-NGWORLD_BG.png`)" fluid></b-img>
            </nuxt-link>
        </div>
    </div>
    <!-- header image mobile-->
    <div class="row header-mobile">
        <div class="col-12 header text-left py-2 px-5">
            <nuxt-link :to="{patch : '/'}">
                <b-img class="header-img" style="margin-left: -10px;" :src="require(`@/assets/img/SECTION_HEADER_LOGO/LOGO-NGWORLD_BG.png`)"  fluid></b-img>
            </nuxt-link>
        </div>
    </div>
    <!-- manu list -->
